...
namespace RegularExam
{
    internal class Program
    {
        ...
        private static void GetFlowerWithLowestPrice(string name)
        {
            ...
            Console.WriteLine($"Flower from store {name} has lowest price: {store.GetFlowerWithLowestPrice():F2}");
        }
        ...
        private static void GetFlowerWithHighestPrice(string name)
        {
            ...
            Console.WriteLine($"Flower from store {name} has highest price: {store.GetFlowerWithHighestPrice():F2}");
        }
